...
//setters:
void DW1000Device::setReplyTime(unsigned long replyDelayTimeUs){ _replyDelayTimeUS=replyDelayTimeUs; }
...
void DW1000Device::randomShortAddress(){
    //todo get some real randomness
    _shortAddress[0]=0x97;
    _shortAddress[1]=0x31;
}
...
boolean DW1000Device::isInactive(){
    ...
    if(millis()-_activity>INACTIVITY_TIME){
        _activity=(millis()-(5+INACTIVITY_TIME));
        return true;
    }
    return false;
}

...
#define dw1000Serial if(false)Serial
...
//DW1000Time.h #define TIME_RES 0.000015650040064103
//DW1000Time.h #define TIME_RES_INV 63897.6

// time stamp byte length
//DW1000Time.h #define LEN_STAMP 5
...
public:
	...
	*/
	static void begin(int ss, int irq, int rst);
	...
	*/
	...
	preamble length). */
	static const byte MODE_IN_CIRCUIT_1[];
